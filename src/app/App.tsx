...
function Background() {
  ...
  /*
    The About page has its own video background.
    The home page uses back.png.
    Art and Films use black.
  */
  const usesPhotoBackground = location.pathname === "/";

  const backgroundImage = `${import.meta.env.BASE_URL}back.png`;
  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .leak-a {
          animation: leakA 48s ease-in-out infinite;
        }

        .leak-b {
          animation: leakB 64s ease-in-out infinite;
        }
