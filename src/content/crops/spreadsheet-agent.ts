...
export const SPREADSHEET_AGENT_CROPS = {
  ...
  'sa-plan-unused': crop({
    ...
    height: 636,
    widths: [640, 960, 1060],
    alt: 'The lower part of the build plan. Sort: Product Name, ascending. Row limit: all matching rows. A note reads “Not used: compare, across. These words did not map to a field or filter, so they had no effect on the plan.” Below it, 1,200 rows, 6 columns, Discard and Build sheet.',
  ...
  'sa-plan-panel': crop({
    ...
    height: 1486,
    widths: [480, 800],
    alt: 'The whole assistant panel, with the request “Compare vendor prices across B2B products” and the build plan with its source, filters, columns, sort, row limit, the words not used, and the Discard and Build sheet controls.',
