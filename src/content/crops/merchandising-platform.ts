...
export const MERCHANDISING_PLATFORM_CROPS = {
  ...
  'mp-catalog': crop({
    ...
    height: 1486,
    widths: [640, 960, 1280, 1600],
    alt: 'Merch Console catalog: “Every SKU with its vendor, unit economics, stock position and trailing performance on one row.” Filters for category, vendor and stock state, 240 of 240 SKUs, and rows with product, vendor, status, price, margin, 28-day units and revenue, on hand, cover and state; Everyday Notebook shows 0 on hand and Out of stock.',
  ...
  'mp-economics': crop({
    ...
    height: 622,
    widths: [640, 960, 1036],
    alt: 'Part of the Canyon Pouch product record: chance of running out before a restock arrives 0%, modeled over the next 45 days against 903 units available; unit economics with list price $70.91, landed cost $39.36, landed cost 12 weeks ago $41.43, fulfillment cost $6.13, web channel fee $2.06, contribution $23.36 per unit or 32.9% of price, and break-even price $46.85.',
  ...
  'mp-working': crop({
    ...
    height: 622,
    widths: [640, 960, 1036],
    alt: 'The working behind the Canyon Pouch order: v = 11.71 units per day, σ = 4.15 units per day, L = 45 days; lead time demand 527.1 units; safety stock = 1.645 × σ × √L = 45.8 units; reorder point 573.0 units; order up to 1100.1 units; order = 1100.1 − 903 − 0 = 197.1, rounded up and floored at the 200 unit MOQ = 200 units. Below: “This is a calculation and a CSV export. The console does not place orders.”',
  ...
  'mp-ask': crop({
    ...
    height: 700,
    widths: [640, 960, 1167],
    alt: 'Merch Console Ask screen: “Type a merchandising question and this runs it against the joined catalog. It matches your question against a fixed set of query shapes and shows you the query it ran. There is no language model involved.” The question “What is out of stock?”, suggested questions, and the query it ran: metric Products at risk of stocking out, category All, vendor All.',
