...
export const CAFEPRESS_UK_CROPS = {
  ...
  'cp-header-brand': crop({
    ...
    height: 401,
    widths: [640, 712],
    alt: 'Detail of the storefront prototype: a Fast UK Delivery notice, the CafePress Business UK logo, the first product categories (Clothing & Workwear, Drinkware, Bags) and the headline Branded Promotional Products for UK Businesses.',
  ...
  'cp-header-nav': crop({
    ...
    caption: 'Detail of the storefront prototype: the right side of the header and the category row.',
    source: 'PlanetArt/cafepress uk/uk web.png',
