/* eslint-disable react-hooks/set-state-in-effect -- Supplied animation state machine synchronizes its phase when input text changes. */
...
function OriginkitBase_TypewriterText(props: Props) {
  const {
    prefix = "",
    texts = DEFAULT_TEXTS,
    font = DEFAULT_FONT,
...
export default function TypewriterText(props: Record<string, unknown>) {
  return <OriginkitBase_TypewriterText {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
