...
export const IMAGES = {
  ...
  'sa-stage-request': img({
    id: 'sa-stage-request', file: 'sa-stage-request', width: 2060, height: 1287, widths: [800, 1200, 1600, 2060], fallback: 'jpg',
    alt: 'Spreadsheet Agent with an empty untitled sheet; the assistant panel holds the request “Create a sheet of B2B products with vendor, cost, retail price, and margin.”',
    caption: 'The request, before anything is built.',
    provenance: 'independent-prototype', synthetic: true,
    source: 'spreadsheetagent.netlify.app (live prototype, captured 2026-09-25 with the request “Create a sheet of B2B products with vendor, cost, retail price, and margin”)', role: 'Spreadsheet Agent stage 1',
  }),
  'sa-stage-plan': img({
    id: 'sa-stage-plan', file: 'sa-stage-plan', width: 2060, height: 1287, widths: [800, 1200, 1600, 2060], fallback: 'jpg',
    alt: 'The build plan for the request: source Northwind product catalog with 1,200 synthetic records, no filters, the columns SKU, Product Name, Vendor, Cost, Retail Price and Margin Percent, sorted by product name, with Discard and Build sheet.',
    caption: 'The plan, waiting for review.',
    provenance: 'independent-prototype', synthetic: true,
    source: 'spreadsheetagent.netlify.app (live prototype, captured 2026-09-25 with the request “Create a sheet of B2B products with vendor, cost, retail price, and margin”)', role: 'Spreadsheet Agent stage 2',
  }),
  'sa-stage-sheet': img({
    id: 'sa-stage-sheet', file: 'sa-stage-sheet', width: 2060, height: 1287, widths: [800, 1200, 1600, 2060], fallback: 'jpg',
    alt: 'The finished Vendor Pricing and Margin sheet with 1,200 rows and six columns, beside the reply confirming what was built.',
  ...
  'sa-trace-cell': img({
    ...
    alt: 'A sheet excerpt with the Vendor cell Atlas Goods selected, in the row for Charcoal Brushed Bound Notebook.',
    caption: 'The selected value.',
    provenance: 'independent-prototype', synthetic: true,
    source: 'spreadsheetagent.netlify.app (live prototype, captured 2026-09-25 with the request “Create a sheet of B2B products with vendor, cost, retail price, and margin”)', role: 'Spreadsheet Agent stage 4 (the selected cell)',
  }),
  'sa-trace-detail': img({
    id: 'sa-trace-detail', file: 'sa-trace-detail', width: 1070, height: 346, widths: [800, 1070], fallback: 'jpg',
    alt: 'The source detail for the selected value: the field northwind.catalog.products[].vendor.name, dataset Northwind Goods product catalog v1.0.0, record B2B-1595, definition Supplier of record for the item, and why this column: chosen because the request is about this topic.',
    caption: 'The catalog field behind the value.',
    provenance: 'independent-prototype', synthetic: true,
    source: 'spreadsheetagent.netlify.app (live prototype, captured 2026-09-25 with the request “Create a sheet of B2B products with vendor, cost, retail price, and margin”)', role: 'Spreadsheet Agent stage 4 (the source detail)',
  }),
  'merch-ask': img({
