 ...
 * Method, tools, confidence and every source disagreement: docs/transcripts.md.
 *
...
export const TRANSCRIPTS: Partial<Record<VideoId, ReactNode>> = {
  ...
  nickleby: (
    <>
      ...
      <p>
        <em>[Title card: “Meet the Makers”.]</em>
      </p>
      <p>
      ...
      <p>
        <em>[End card: Nickleby Capital logo and “See more at nicklebycapital.com”.]</em>
      </p>
    </>
  ),
  heck: (
